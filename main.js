function startClassification() { navigator.mediaDevices.getUserMedia({ audio: true});
 classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/GsYfngmG4/model.json', modelReady); } 
...
document.getElementById("result_accuracy").innerHTML = 'accuracy level - '+ (results[0].confidence*100).toFixed(3)+"%";
